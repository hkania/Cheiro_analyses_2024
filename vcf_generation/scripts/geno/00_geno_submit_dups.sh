...
# SETUP ------------------------------------------------------------------------
## Scripts
SCRIPT_GENO_INDS=/datacommons/yoderlab/users/hkania/cheiro_tests_june24/scripts/test_scripts/test_dups_01.sh
...
## Input files
IDS_FILE_ALL=/datacommons/yoderlab/users/hkania/cheiro_tests_june24/metadata/full_dup_names.txt
###IDS_FILE_HZPROJ1=metadata/cheiro_metadata.tsv
META_FILE=/datacommons/yoderlab/users/hkania/cheiro/metadata/full_formatted_metadata.tsv
...
for id_short in ${ids_short[@]}; do
    ...
    grep "$id_short" "$META_FILE" | cut -f 20 > "$id_long_file"
