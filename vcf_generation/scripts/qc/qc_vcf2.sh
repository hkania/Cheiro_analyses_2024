...
set -euo pipefail
export PATH=/datacommons/yoderlab/programs/htslib-1.20/bin:/datacommons/yoderlab/programs/bcftools-1.20/bin:/datacommons/yoderlab/programs/vcftools/vcftools-0.1.16/bin:$PATH

# SET-UP -----------------------------------------------------------------------
## Software
SOFTWARE=/datacommons/yoderlab/programs
BCFTOOLS=$SOFTWARE/bcftools-1.20/bcftools
TABIX=$SOFTWARE/htslib-1.20/tabix
BGZIP=$SOFTWARE/htslib-1.20/bgzip
